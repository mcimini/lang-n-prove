...
typeOf (composeFun E1 E2 E3) T3 :- typeOf E1 T1, typeOf E2 (arrow T1 T2), typeOf E3 (arrow T2 T3).
step (composeFun V1 V2 V3) (app V3 (app V2 V1)).
...
step (composeFun E1 E2 E3) (composeFun E1' E2 E3) :- step E1 E1'.

step (composeFun E1 E2 E3) (composeFun E1 E2' E3) :- step E2 E2', value E1.

step (composeFun E1 E2 E3) (composeFun E1 E2 E3') :- step E3 E3', value E2, value E1.
...
step (composeFun E1 E2 E3) E1 :- error E1.

step (composeFun E1 E2 E3) E2 :- error E2, value E1.

step (composeFun E1 E2 E3) E3 :- error E3, value E2, value E1.
