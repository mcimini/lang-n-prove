...
typeOf (map E1 E2) (list T2) :- typeOf E1 (list T1), typeOf E2 (arrow T1 T2).
step (map (emptyList) V) (emptyList).
...
step (map E1 E2) (map E1' E2) :- step E1 E1'.

step (map E1 E2) (map E1 E2') :- step E2 E2', value E1.
...
step (map E1 E2) E1 :- error E1.

step (map E1 E2) E2 :- error E2, value E1.
