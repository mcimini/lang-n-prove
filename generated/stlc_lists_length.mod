...
typeOf (length E) (int) :- typeOf E (list T).
step (length (emptyList)) (zero).

step (length (cons V1 V2)) (succ (length V2)).
...
step (length E1) (length E1') :- step E1 E1'.
