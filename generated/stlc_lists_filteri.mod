...
typeOf (filteri E1 E2 E3) (list T) :- typeOf E1 (list T), typeOf E2 (arrow (int) (arrow T (bool))), typeOf E3 (int).
step (filteri (emptyList) V1 V2) (emptyList).

step (filteri (cons V1 V2) V3 V4) (if (app (app V3 V4) V1) (cons V1 (filteri V2 V3 (succ V4))) (filteri V2 V3 (succ V4))).
...
step (filteri E1 E2 E3) (filteri E1' E2 E3) :- step E1 E1'.

step (filteri E1 E2 E3) (filteri E1 E2' E3) :- step E2 E2', value E1.

step (filteri E1 E2 E3) (filteri E1 E2 E3') :- step E3 E3', value E2, value E1.
...
step (filteri E1 E2 E3) E1 :- error E1.

step (filteri E1 E2 E3) E2 :- error E2, value E1.

step (filteri E1 E2 E3) E3 :- error E3, value E2, value E1.
