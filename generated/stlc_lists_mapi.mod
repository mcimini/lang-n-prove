...
typeOf (mapi E1 E2 E3) (list T2) :- typeOf E1 (list T1), typeOf E2 (arrow (int) (arrow T1 T2)), typeOf E3 (int).
step (mapi (emptyList) V1 V2) (emptyList).

step (mapi (cons V1 V2) V3 V4) (cons (app (app V3 V4) V1) (mapi V2 V3 (succ V4))).
...
step (mapi E1 E2 E3) (mapi E1' E2 E3) :- step E1 E1'.

step (mapi E1 E2 E3) (mapi E1 E2' E3) :- step E2 E2', value E1.

step (mapi E1 E2 E3) (mapi E1 E2 E3') :- step E3 E3', value E2, value E1.
...
step (mapi E1 E2 E3) E1 :- error E1.

step (mapi E1 E2 E3) E2 :- error E2, value E1.

step (mapi E1 E2 E3) E3 :- error E3, value E2, value E1.
