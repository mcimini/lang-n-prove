module stlc_lists_filterToOptions.
...
typeOf (filterToOptions E1 E2 E3) (list (option T)) :- typeOf E1 (list T), typeOf E2 (arrow (int) (arrow T (bool))), typeOf E3 (int).
...
step (filterToOptions (emptyList) V1 V2) (emptyList).

step (filterToOptions (cons V1 V2) V3 V4) (cons (if (app (app V3 V4) V1) (some V1) (none)) (filterToOptions V2 V3 (succ V4))).
...
step (filterToOptions E1 E2 E3) (filterToOptions E1' E2 E3) :- step E1 E1'.

step (filterToOptions E1 E2 E3) (filterToOptions E1 E2' E3) :- step E2 E2', value E1.

step (filterToOptions E1 E2 E3) (filterToOptions E1 E2 E3') :- step E3 E3', value E2, value E1.
...
step (filterToOptions E1 E2 E3) E1 :- error E1.

step (filterToOptions E1 E2 E3) E2 :- error E2, value E1.

step (filterToOptions E1 E2 E3) E3 :- error E3, value E2, value E1.
