...
typeOf (filter E1 E2) (list T) :- typeOf E1 (list T), typeOf E2 (arrow T (bool)).
step (filter (emptyList) V) (emptyList).

step (filter (cons V1 V2) V3) (if (app V3 V1) (cons V1 (filter V2 V3)) (filter V2 V3)).
...
step (filter E1 E2) (filter E1' E2) :- step E1 E1'.

step (filter E1 E2) (filter E1 E2') :- step E2 E2', value E1.
...
step (filter E1 E2) E1 :- error E1.

step (filter E1 E2) E2 :- error E2, value E1.
